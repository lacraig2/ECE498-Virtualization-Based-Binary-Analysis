...
int before_block_exec(CPUState *env, TranslationBlock *tb) {
	...
	if (panda_in_kernel(env)){
		...
		uint64_t page_val = esp & 0b1111111111111111111111111111111111111111111111111111000000000000;
		uint64_t page_val2 = ebp &  0b1111111111111111111111111111111111111111111111111111000000000000;
